(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/regenerator'), require('ethers'), require('@babel/runtime/helpers/inherits'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/getPrototypeOf')) :
  typeof define === 'function' && define.amd ? define(['@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/createClass', '@babel/runtime/regenerator', 'ethers', '@babel/runtime/helpers/inherits', '@babel/runtime/helpers/possibleConstructorReturn', '@babel/runtime/helpers/getPrototypeOf'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.tropykus = factory(global._asyncToGenerator, global._classCallCheck, global._createClass, global._regeneratorRuntime, global.ethers, global._inherits, global._possibleConstructorReturn, global._getPrototypeOf));
})(this, (function (_asyncToGenerator, _classCallCheck, _createClass, _regeneratorRuntime, ethers, _inherits, _possibleConstructorReturn, _getPrototypeOf) { 'use strict';
  ...
  var Comptroller = function () {
    function Comptroller(contractAddress, tropykus) {
      ...
      this.instance = new ethers.ethers.Contract(contractAddress, ComptrollerArtifact.abi, this.tropykus.ethersProvider);
    }
    _createClass__default["default"](Comptroller, [{
      ...
      value: function setCollateralFactor(marketAddresses, collateralFactor) {
        var _this5 = this;
        return new Promise(function (resolve, reject) {
          _this5.instance.connect(_this5.tropykus.account)._setCollateralFactor(marketAddresses, ethers.ethers.utils.parseEther(collateralFactor.toString())).then(resolve).catch(reject);
        });
      }
    }, {
      key: "become",
      ...
      value: function setCloseFactor(closeFactor) {
        var _this8 = this;
        return new Promise(function (resolve, reject) {
          _this8.instance.connect(_this8.tropykus.account)._setCloseFactor(ethers.ethers.utils.parseEther(closeFactor.toString())).then(resolve).catch(reject);
        });
      }
    }, {
      ...
      value: function setLiquidationIncentive(liquidationIncentive) {
        var _this9 = this;
        return new Promise(function (resolve, reject) {
          _this9.instance.connect(_this9.tropykus.account)._setLiquidationIncentive(ethers.ethers.utils.parseEther(liquidationIncentive.toString())).then(resolve).catch(reject);
        });
      }
    }]);
    return Comptroller;
  ...
  var PriceOracle = function () {
    function PriceOracle(contractAddress, tropykus) {
      _classCallCheck__default["default"](this, PriceOracle);
      this.tropykus = tropykus;
      this.instance = new ethers.ethers.Contract(contractAddress, PriceOracleProxyArtifact.abi, this.tropykus.ethersProvider);
    }
    _createClass__default["default"](PriceOracle, [{
  ...
  var Market = function () {
    ...
    _createClass__default["default"](Market, [{
      ...
      value: function setReserveFactor(reserveFactor) {
        var _this6 = this;
        return new Promise(function (resolve, reject) {
          _this6.instance.connect(_this6.tropykus.account)._setReserveFactor(ethers.ethers.utils.parseEther(reserveFactor.toString())).then(resolve).catch(reject);
        });
      }
    }]);
    return Market;
  ...
  var CRBTC = function (_Market) {
    ...
    var _super = _createSuper$3(CRBTC);
  ...
  var CErc20 = function (_Market) {
    _inherits__default["default"](CErc20, _Market);
    var _super = _createSuper$2(CErc20);
    function CErc20(tropykus, abi, contractAddress, erc20TokenAddress) {
      var _this;
      _classCallCheck__default["default"](this, CErc20);
      ...
      _this.erc20Instance = new ethers.ethers.Contract(erc20TokenAddress, StandartTokenArtifact.abi, _this.tropykus.ethersProvider);
      return _this;
    }
    _createClass__default["default"](CErc20, [{
      key: "mint",
      value: function () {
  ...
  var CRDOC = function (_CErc) {
    _inherits__default["default"](CRDOC, _CErc);
    var _super = _createSuper$1(CRDOC);
    function CRDOC(tropykus, contractAddress, erc20TokenAddress) {
      _classCallCheck__default["default"](this, CRDOC);
  ...
  var cToken = function (_CErc) {
    _inherits__default["default"](cToken, _CErc);
  ...
  var Unitroller = function () {
    function Unitroller(contractAddress, tropykus) {
      _classCallCheck__default["default"](this, Unitroller);
      this.tropykus = tropykus;
      this.address = contractAddress;
      this.instance = new ethers.ethers.Contract(contractAddress, UnitrollerArtifact.abi, this.tropykus.ethersProvider);
    }
    _createClass__default["default"](Unitroller, [{
  ...
  var Tropykus = function () {
    ...
    _createClass__default["default"](Tropykus, [{
      ...
      key: "addMarket",
      value: function () {
        var _addMarket = _asyncToGenerator__default["default"]( _regeneratorRuntime__default["default"].mark(function _callee(artifact) {
          var deployed,
              marketAddress,
              erc20TokenAddress,
              args,
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  break;
                case 9:
                  marketFactory = new ethers.ethers.ContractFactory(CRBTCArtifact.abi, CRBTCArtifact.bytecode, this.account);
                  _context.next = 12;
                  return marketFactory.deploy(args.comptrollerAddress, args.interestRateModelAddress, ethers.ethers.utils.parseEther(args.initialExchangeRate.toString()), args.name, args.symbol, args.decimals, this.account.address);
                case 12:
                  marketDeployed = _context.sent;
                  return _context.abrupt("break", 18);
                case 14:
                  marketFactory = new ethers.ethers.ContractFactory(CRDOCArtifact.abi, CRDOCArtifact.bytecode, this.account);
                  return _context.abrupt("break", 18);
                case 16:
                  marketFactory = new ethers.ethers.ContractFactory(CErc20Artifact.abi, CErc20Artifact.bytecode, this.account);
                  return _context.abrupt("break", 18);
                case 18:
                  if (!(artifact !== 'CRBTC')) {
                    _context.next = 22;
                  ...
                  _context.next = 21;
                  return marketFactory.deploy(erc20TokenAddress, args.comptrollerAddress, args.interestRateModelAddress, ethers.ethers.utils.parseEther(args.initialExchangeRate.toString()), args.name, args.symbol, args.decimals, this.account.address);
                case 21:
                  marketDeployed = _context.sent;
                case 22:
      ...
      key: "setComptroller",
      value: function () {
        var _setComptroller = _asyncToGenerator__default["default"]( _regeneratorRuntime__default["default"].mark(function _callee2(comptrollerAddress) {
          var deployed,
              args,
              unitrollerFactory,
              unitrollerDeployed,
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  unitrollerFactory = new ethers.ethers.ContractFactory(UnitrollerArtifact.abi, UnitrollerArtifact.bytecode, this.account);
                  _context2.next = 6;
                ...
                case 6:
                  ...
                  comptrollerFactory = new ethers.ethers.ContractFactory(ComptrollerArtifact.abi, ComptrollerArtifact.bytecode, this.account);
                  _context2.next = 11;
