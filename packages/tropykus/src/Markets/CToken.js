...
export default class CToken extends Market {
    constructor(contractAddress, tropykus, erc20TokenAddress) {
        ...
        this.erc20Instance = new ethers.Contract(erc20TokenAddress, StandartTokenAbi, this.tropykus.ethersProvider);
    }
